---
id: network-detail
title: নেটওয়ার্কের বিস্তারিত তথ্য কীভাবে পড়তে হয়?
description: "নেটওয়ার্কের বিস্তারিত তথ্যে JSON-এর প্রতিক্রিয়া কীভাবে বুঝতে হবে।"
keywords:
  - docs
  - matic
  - polygon
...
# নেটওয়ার্ক বিবরণ রিডিং {#reading-network-details}

আপনি নিচে শেয়ার করা সহায়তা লিংকে ভিজিট করার মাধ্যমে নেটওয়ার্কের বিস্তারিত তথ্য পেতে পারবেন।
- নেটওয়ার্ক কনফিগ: <static.matic.network/network/"network_name"/"version"/index.json>

## উদাহরণ {#example}

TestnetV3-এর জন্য: https://static.matic.network/network/testnet/v3/index.json
