...
Einführung in einen Teil der Terminologie, bevor wir die Exit-Szenarien weiter diskutieren.
...
### C. Exit von einer In-Flight-Übertragung (MoreVP) {#c-exit-from-an-in-flight-transaction-morevp}
