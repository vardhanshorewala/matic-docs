...
id: validators
title: Validatoren
description: "Heimdalls Struktur für Validatoren."
keywords:
  - docs
  - matic
image: https://matic.network/banners/matic-network-16x9.png
---
Validatoren sind ein wesentlicher Bestandteil des Heimdall. Heimdall bietet die Möglichkeit, Validatoren am Ende jedes Blocks zu wechseln. Dies nennt sich `EndBlocker`Es ist Teil der Cosmos-SDK: [https://docs.cosmos.network/master/building-modules/beginblock-endblock.html](https://docs.cosmos.network/master/building-modules/beginblock-endblock.html)

Heimdall verwendet die folgende Struktur für den Validator:
