---
id: network-detail
title: Come leggere i dettagli di rete?
description: "Come comprendere la risposta JSON relativa ai dettagli di rete."
keywords:
  - docs
  - matic
  - polygon
...
# Legare i dettagli della rete {#reading-network-details}

Puoi ottenere i dettagli di rete consultando i link di supporto condivisi di seguito.
- Configurazione di rete: <static.matic.network/network/"network_name"/"version"/index.json>

## Esempio {#example}

Per TestnetV3: https://static.matic.network/rete/testnet/v3/index.json
