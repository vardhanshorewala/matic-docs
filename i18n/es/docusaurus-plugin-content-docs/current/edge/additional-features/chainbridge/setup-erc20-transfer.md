...
Eso ejecuta la transacción de enviar tokens a la cuenta del destinatario en la cadena Polygon Edge después de que el número requerido de votos sean presentados.
