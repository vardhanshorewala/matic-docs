...
Por esa razón, necesitarás usar el modo de bloqueo/liberación en la cadena pública y el modo de quemar/acuñar en la cadena privada.
...
Este ejemplo te guía con el proyecto hardhat [ejemplo Trapesys/chainbridge](https://github.com/Trapesys/chainbridge-example).
...
Revisar [Configuración](/docs/edge/additional-features/chainbridge/setup) para más detalles.

Llamarás a aprobación antes de la transferencia.
