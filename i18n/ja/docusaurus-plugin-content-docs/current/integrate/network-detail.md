...
id: network-detail
title: ネットワーク詳細を読む方法
description: "ネットワーク詳細に対するJSONレスポンスを理解する方法"
keywords:
  - docs
  - matic
  - polygon
...
# ネットワーク詳細を読む {#reading-network-details}

下記のサポートリンクを訪問することで、ネットワークの詳細が得られます。
- ネットワーク設定： <static.matic.network/network/"network_name"/"version"/index.json>

## 例 {#example}

TestnetV3の場合：https://static.matic.network/network/testnet/v3/index.json
