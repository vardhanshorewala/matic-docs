---
id: network-detail
title: नेटवर्क विवरण कैसे पढ़ें?
description: "नेटवर्क विवरण के लिए JSON जवाब को कैसे समझना चाहिए."
keywords:
  - docs
  - matic
  - polygon
...
# नेटवर्क विवरण {#reading-network-details}

नीचे शेयर किए गए सहायता लिंकों पर जाने से आपको नेटवर्क विवरण मिल सकता है.
- नेटवर्क कॉन्फ़िगरेशन:<static.matic.network/network/"network_name"/"version"/index.json>

## उदाहरण {#example}

TestnetV3 के लिए: https://static.matic.network/network/testnet/v3/index.json
