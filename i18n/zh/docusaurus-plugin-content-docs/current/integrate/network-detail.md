...
您可以通过访问以下共享的支持链接来了解网络详情。
- 网络配置：<static.matic.network/network/"network_name"/"version"/index.json>

## 示例 {#example}

对于 TestnetV3：https://static.matic.network/network/testnet/v3/index.json
