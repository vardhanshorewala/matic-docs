---
id: network-detail
title: Bagaimana cara membaca Detail Jaringan ?
description: "Cara memahami respon JSON ke Detail Jaringan."
keywords:
  - docs
  - matic
  - polygon
...
# Membaca Rincian Jaringan {#reading-network-details}

Anda dapat memiliki detail jaringan dengan mengunjungi tautan dukungan bersama di bawah.
- Config jaringan: <static.matic.network/network/"network_name"/"version"/index.json>

## Contoh {#example}

Untuk TestnetV3: https://static.matic.net/network/testnet/v3/index.json
