---
id: network-detail
title: Como ler os detalhes da rede?
description: "Como entender a resposta JSON para os detalhes da rede."
keywords:
  - docs
  - matic
...
Pode obter os detalhes da rede através dos links de suporte partilhados abaixo.
- Config de rede: <static.matic.network/network/"network_name"/"version"/index.json>
