---
id: intro-generic-sm
title: Introduction To A Generic State Machine 
sidebar_label: Introduction To A Generic State Machine
description: Introducing the basic components of a generic state machine
keywords:
