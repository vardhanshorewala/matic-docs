---
id: mfibonacci-state-machine
title: Multiplicative Fibonacci State Machine 
sidebar_label: Multiplicative Fibonacci State Machine
description: A simple example of a state machine
keywords:
...
## Constructing An mFibonacci State Machine
...
<div align="center"><b> Figure 1: mFibonacci SM with two registries </b></div>
...
![Figure 2: mFibonacci SM with three registries](figures/fib7-mfibon-sm-3-regs.png)

<div align="center"><b> Figure 2: mFibonacci SM with three registries </b></div>
...
![Figure 3: Code Example of the mFibonacci SM's Computation Trace](figures/fib8-code-eg-exec-trace.png)

<div align="center"><b> Figure 3: Code Example of the mFibonacci SM's Computation Trace </b></div>
